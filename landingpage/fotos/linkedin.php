  ...
  <main class="main_content container">
    ...
    <section class="section-seu-codigo container">
      ...
      <div class="content">
        ...
        <h1 class="section_title"><i class="icon icon-code"></i> Galeria de Fotos para LinkedIn - Work In Tech</h1>
        ...
        <div class="box-artigo">
          ...
          <div id="vlightbox1">
            ...
            for ($x = 1; $x <= 98; $x++) {
            ?>
              <a class="vlightbox1" id="lightbox-responsiva" style="max-width: 480px; max-height:240px; overflow:hidden;" href="galeria/linkedin/linkedin-<?= $x; ?>.jpg" title="Foto 1">
                <img src="galeria/tb-linkedin/tb-linkedin-<?= $x; ?>.jpg" alt="foto 1">
              </a>
        ...
        <div class="download-footer"><h1><a href="https://drive.google.com/drive/folders/1tPJP6O8n9NqAvh9Oyptv4RBNnhla1sKF?usp=sharing" target="_blank">Ver fotos no Google Drive</a></h1></div>
      </div>
